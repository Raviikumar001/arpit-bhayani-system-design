...
export function CategoryBrowser({ type, level, videos }: CategoryBrowserProps) {
    ...
    const title = type === 'motivational' ? "Motivation & Advice" : `${level} Concepts`;
    const description = type === 'motivational'
